...
for step in range(50, 350, 50):
    ...
    plt.plot(x[0:50], y_scone[start:step], marker = 'X', c = 'b', label="SGX-A", linestyle = 'dotted', ms = 20)
    plt.plot(x[0:50], y[start:step], marker = 'o', c = 'g', label="SGX-E", linestyle = 'dotted', ms = 20)
    plt.plot(x[0:50], y_normal[start:step], marker = '*', c = 'r', label="Nat-A", linestyle = 'dotted', ms = 20)
