...
#include "hmac_lib.h"
	...
	inline bool sign_msg(uint8_t *plain_text, size_t plain_text_sz, uint8_t *private_key /* unused */,
			uint8_t *signed_msg_buf) {

		auto [signed_digest, sz] = hmac_sha256(plain_text, plain_text_sz);
	...
	inline bool verify_msg(uint8_t *signed_msg_buff, uint8_t *public_key /* unused */) {
		...
		auto [signed_digest, sz] = hmac_sha256(signed_msg_buff + _max_hash_sz + sizeof(plain_text_sz), plain_text_sz);
