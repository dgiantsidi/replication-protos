        ...
        auto process = [&] () -> std::pair<int, std::unique_ptr<char[]>> {
            ...
            switch (op) 
            {
                ...
                default: {
                             ...
                             auto decrypted_length = pub_verify_sha256(reinterpret_cast<uint8_t *>(buffer.get()), bytecount, reinterpret_cast<uint8_t *>(publicKey), ptr_dec);
                             ...
                             auto computed_hash =
                                 get_sha256(reinterpret_cast<char *>(buffer.get() + signature_size), (bytecount - signature_size));
